    ...
    <div class="container">
      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          ...
          <!-- <?php   //Menu register under functions->features for WP Menu
            wp_nav_menu(array(
          ...
          <ul>       
            ...
            <li <?php if (is_page('uber-uns') or wp_get_post_parent_id(0) == 7) echo 'class="current-menu-item"' ?>><a href="<?php echo site_url('/uber-uns') ?>">Über uns</a></li>
          </ul>
        </nav>
